  ...
  DICM_MESSAGE(kDicmInvalidArgument, "Invalid argument passed to the function")
      DICM_MESSAGE(kDicmOutOfOrder,
          ...
          DICM_MESSAGE(kDicmInvalidVR,
              ...
              DICM_MESSAGE(kDicmReservedNotZero,
                           "Reserved for VR32 should be 0")
                  DICM_MESSAGE(kPixelDataIsVR16,
                               "Pixel Data is encoded on VR 16")
                      DICM_MESSAGE(kEncapsulatedPixelDataIsNotOB,
                                   "Encapsulated Pixel Data is not OB")
                          DICM_MESSAGE(kDicmOddDefinedLength,
                                       "Defined Length is Odd")
                              DICM_MESSAGE(
                                  kNotEnoughData,
                                  "Not enough bytes could be read from source.")
